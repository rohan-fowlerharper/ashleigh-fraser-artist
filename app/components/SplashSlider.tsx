...
export default function SplashSlider() {
  return (
    <div className="mx-auto flex max-w-4xl flex-col md:max-h-full md:flex-row">
      <div className="flex aspect-[3/4] h-auto w-full flex-col items-center justify-center bg-zinc-50 p-8 text-center xs:mx-auto xs:w-[384px] sm:mx-auto sm:w-[384px] md:w-1/2">
      ...
      <div className="w-full xs:mx-auto xs:w-[384px] sm:mx-auto sm:w-[384px] md:w-1/2">
        <Swiper {...swiperParams}>
          <SwiperSlide>
